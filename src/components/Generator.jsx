  ...
  return (
    <SectionWrapper id = {'generate'} header="generate your workout" title={["It's", 'Huge', "o'clock"]}>
        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              key={typeIndex}
              className={
                'py-3 border-blue-400 border-2 border-solid rounded-lg bg-slate-950 duration-200 hover:border-blue-600 ' +
      ...
      <div className="bg-slate-950 border border-solid border-blue-400 rounded-lg flex flex-col">
        <button onClick={toggleModal} className="p-3 flex relative items-center justify-center">
      ...
      <Button func = {updateWorkout} content={'Formulate'}></Button>
    </SectionWrapper>
  );
}
